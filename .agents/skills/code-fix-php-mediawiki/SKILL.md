...
- `references/07-universal-test-write.md`
- `references/08-php-test-write-php.md`
- `references/09-mediawiki-test-write-php-mediawiki.md`
- `references/10-mediawiki-install-deps.md`
- `references/11-mediawiki-run-tests-phpunit.md`
- `references/12-mediawiki-run-pre-commit.md`
- `references/13-mediawiki-debug-browser-playwright.md`
