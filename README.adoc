...
image:https://github.com/gesinn-it/EditWarning/actions/workflows/main.yml/badge.svg[CI,link=https://github.com/gesinn-it/EditWarning/actions/workflows/main.yml]
image:https://codecov.io/gh/gesinn-it/EditWarning/branch/master/graph/badge.svg[Codecov,link=https://app.codecov.io/gh/gesinn-it/EditWarning]
...
|$wgEditWarning_ShowInfoBox
|false
|Displays a info box for the first editor.

|$wgEditWarning_Timeout
|10
|Timout until a edit warning is removed automatically.
|===
